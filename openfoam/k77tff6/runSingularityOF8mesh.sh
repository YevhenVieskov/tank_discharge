...
## session variables
FOAM_SINGULARITY_IMAGE=/home/veskovev/work/OPENFOAM_8_SINGULARITY/openfoam8.sif
FOAM_BASHRC=/opt/openfoam8/etc/bashrc
...
singularity exec  --pwd=/${home_dir}  instance://${instance_name} bash -c "source ${FOAM_BASHRC} && ./meshint"
